...
class Cli
{
    ...
    public function createBlock($args, $assocArgs)
    {
        ...
        $fieldsJsonPath = $blockPath . '/fields.json';
      ...
      EOT;
            ...
            file_put_contents($fieldsJsonPath, $fieldsJson);

            \WP_CLI::success('Fields JSON created');
        } else {
            \WP_CLI::error('Fields JSON already exists');
        }
